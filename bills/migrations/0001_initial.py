    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratio', models.FloatField(help_text='발행시 계산합니다.', null=True, verbose_name='소실율')),
                ('start_date', models.DateField(verbose_name='시작일')),
                ('bill_date', models.DateField(default=django.utils.timezone.now, verbose_name='청구일')),
                ('total', models.PositiveIntegerField(help_text='상가 전체에 해당하는 전기료 청구금액의 합계', verbose_name='총청구금액')),
                ('maintanance', models.PositiveIntegerField(help_text='상가 관리단 전기료의 합계', verbose_name='관리실금액')),
                ('floor', models.PositiveIntegerField(help_text='부가세가 포함된 4층 전기료 청구요금', verbose_name='한전 청구요금')),
                ('basic', models.PositiveIntegerField(help_text='적용요금에 따른 기본 요금', verbose_name='한전 기본요금')),
                ('usage', models.PositiveIntegerField(blank=True, help_text='청구서에 기재된 전력사용량', verbose_name='당월 사용량(kw)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usage', models.PositiveIntegerField(blank=True, null=True, verbose_name='검침량')),
                ('public_share', models.PositiveIntegerField(verbose_name='공용 기본전기료')),
                ...
                ('bill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='bills.bill', verbose_name='당월 청구서 정보')),
                ('contract', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoices', to='contracts.contract', verbose_name='계약자 정보')),
            ],
            options={
                'verbose_name': '인보이스',
        ...
        migrations.AddField(
            model_name='bill',
            name='owner_charge',
            field=models.ManyToManyField(blank=True, related_name='bills', to='bills.ownercharge', verbose_name='임대인 부담'),
        ),
    ]
